...
const copy = {
  vi: {
    ...
    aboutText: "Tôi là người khá điềm tĩnh, tò mò và thường muốn hiểu một điều đến nơi đến chốn. Trong công việc, tôi bắt đầu bằng việc lắng nghe người sẽ sử dụng tính năng, làm rõ luồng nghiệp vụ và tìm những trường hợp dễ bị bỏ sót trước khi viết code. Tôi ưu tiên giải pháp dễ đọc, dễ kiểm tra và vừa đủ cho nhu cầu hiện tại, thay vì làm mọi thứ phức tạp ngay từ đầu. Khi có thêm thông tin, tôi sẵn sàng nhìn lại lựa chọn cũ và cải thiện từng bước.",
    principles: [["01", "LẮNG NGHE TRƯỚC KHI LÀM"], ["02", "GIỮ CÁCH LÀM RÕ RÀNG"], ["03", "HỌC, ĐIỀU CHỈNH VÀ CẢI THIỆN"]],
  ...
  en: {
    ...
    aboutText: "I'm fairly calm, naturally curious, and happiest when I can follow something far enough to understand how it really works. At work, I begin by listening to the people who will use a feature, mapping the workflow, and finding the cases that are easy to miss before I write code. I prefer solutions that are easy to read and test, and no more complicated than the current need calls for. When new information changes the picture, I'm comfortable revisiting an earlier decision and improving it step by step.",
    principles: [["01", "LISTEN BEFORE BUILDING"], ["02", "KEEP THE WORK CLEAR"], ["03", "LEARN, ADJUST, IMPROVE"]],

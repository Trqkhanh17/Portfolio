...
const copy = {
  vi: {
    ...
    aboutTitle: ["HIỂU CHO ĐÚNG.", "LÀM CHO TỚI."],
    aboutText: "Tôi đến với lập trình vì thích cảm giác nhìn một ý tưởng dần thành hình và thực sự chạy được. Điều khiến tôi gắn bó với công việc này lại là những lúc chưa biết câu trả lời: đọc thêm một tài liệu, thử một hướng, làm sai rồi hiểu ra vấn đề nằm ở đâu. Tôi không đặt mục tiêu phải biết mọi thứ; tôi muốn có một nền tảng đủ chắc, viết code có chủ đích và vài tháng sau nhìn lại vẫn hiểu vì sao mình đã chọn cách làm đó.",
    principles: [["01", "BẮT ĐẦU TỪ BỐI CẢNH THẬT"], ["02", "GIỮ MỌI THỨ RÕ RÀNG"], ["03", "TỐT HƠN SAU MỖI LẦN LÀM"]],

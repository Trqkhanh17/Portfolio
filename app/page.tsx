  ...
  vi: {
    ...
    projects: [
      ...
      },
      {
        ...
        visual: "AOV",
        description: "Backend đang phát triển cho ứng dụng tìm bạn chơi game Liên Quân Mobile. Dự án hướng đến việc kết nối người chơi thông qua hồ sơ game, hệ thống kết bạn và yêu cầu tìm đội; hiện phần nền tảng tài khoản và bảo mật đã được xây dựng, còn logic matchmaking đang tiếp tục hoàn thiện.",
        features: [
          "Đăng ký và đăng nhập bằng Passport, phát hành JWT access token và refresh token với cơ chế làm mới phiên.",
          "Xem/cập nhật hồ sơ, đổi mật khẩu, đăng xuất và kiểm soát phiên bằng token version.",
          "Xác minh email, quên mật khẩu qua OTP và gửi mail bằng Nodemailer với Handlebars template.",
          "Rate limiting toàn cục và theo từng endpoint để bảo vệ đăng nhập, đăng ký và các thao tác nhạy cảm.",
          "Kiến trúc modular monolith trên NestJS/MongoDB; các module game profile, friend và match search đang trong giai đoạn phát triển.",
        ],
  ...
  en: {
    ...
    projects: [
      ...
      },
      {
        ...
        label: "IN PROGRESS — BACKEND PROJECT",
        visual: "AOV",
        description: "An in-progress backend for an Arena of Valor squad-finder application. The product is designed to connect players through game profiles, friend relationships, and match-search requests; the account and security foundation is implemented while matchmaking logic remains under development.",
        features: [
          "Passport-based registration and login with JWT access and refresh tokens plus session refresh flow.",
          "Profile retrieval and updates, password changes, logout, and token-version session control.",
          "Email verification, OTP-based password recovery, and Nodemailer delivery with Handlebars templates.",
          "Global and endpoint-specific rate limiting for login, registration, and sensitive account actions.",
          "A NestJS/MongoDB modular-monolith foundation with game-profile, friend, and match-search modules currently in progress.",
        ],
        tech: "NESTJS 11 · TYPESCRIPT · MONGODB · MONGOOSE · PASSPORT · JWT · NODEMAILER · THROTTLER",
        links: [["REPOSITORY ↗", "https://github.com/Trqkhanh17/serverTimBanChoiGame"]],
      },

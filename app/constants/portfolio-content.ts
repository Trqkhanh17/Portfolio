  ...
  vi: {
    ...
    projects: [
      ...
      },
      {
        ...
        badge: 'BACK END',
        description:
          'Ý tưởng đến từ một chuyện rất quen thuộc: muốn tìm đúng người để chơi Liên Quân cùng thay vì phó mặc cho việc ghép đội ngẫu nhiên. Tôi đang xây phần server cho sản phẩm này; nền tảng tài khoản và bảo mật đã chạy ổn, còn hồ sơ trong game, kết bạn và cách tìm đồng đội vẫn đang được hoàn thiện.',
        features: [
  ...
  en: {
    ...
    projects: [
      ...
      },
      {
        ...
        badge: 'IN PROGRESS',
        description:
          "The idea came from a familiar problem: finding the right people to play Arena of Valor with instead of relying on a completely random team. I'm building the server behind that product. Its account and security foundation works today; game profiles, friendships, and squad-matching logic are still taking shape.",
        features: [
